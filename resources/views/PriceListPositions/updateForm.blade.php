...
@section('content')
    ...
    <div class="container p-4">
        <form method="POST" action="{{ route('position.update', [$priceListId, $priceListPosition->id]) }}">
            @method('PUT')
            @csrf
            <div class="mb-3">
                <label for="namePriceListPosition" class="form-label">Название</label>
                <input type="text" class="form-control" id="namePriceListPosition" name="name" required value="{{ $priceListPosition->name }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="articlePriceListPosition" name="article" required value="{{ $priceListPosition->article }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pricePriceListPosition" name="price" required value="{{ $priceListPosition->price }}">
